...
学習を始めて約3ヶ月後、AWS Certified Solutions Architect – Associate（SAA）に一発合格することができました（勉強法や模擬試験の点数推移は[AWSの名前も知らなかった介護士がAWS SAAに一発合格するまで](/blog/2026-06-23-aws-saa-pass-as-caregiver)に詳しく書いています）。もちろん資格を取得しただけでエンジニアになれるわけではありません。
