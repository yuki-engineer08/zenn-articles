...
合格後、私は実際に手を動かしてサービスを作り始めた。そこで最初に取り組んだのが、AIエージェントに役割を持たせて開発を進める仕組み作りだった。その話は[介護士がClaude CodeでAI開発チームを作った話](/blog/2026-06-24-caregiver-built-ai-team-with-claude-code)に書く。